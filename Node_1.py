# Node 1
# Назначение:
# 1) Получает выбранный автомат и читает его номер цепи.
# 2) Ищет по модели участки трассы, относящиеся к этой цепи.
# 3) Возвращает список найденных участков для следующих нод.
